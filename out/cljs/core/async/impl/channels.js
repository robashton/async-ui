...
goog.require('cljs.core.async.impl.protocols');
cljs.core.async.impl.channels.box = (function box(val){if(typeof cljs.core.async.impl.channels.t17680 !== 'undefined')
{} else
{
/**
* @constructor
*/
cljs.core.async.impl.channels.t17680 = (function (val,box,meta17681){
this.val = val;
this.box = box;
...
cljs.core.async.impl.channels.t17680.cljs$lang$type = true;
cljs.core.async.impl.channels.t17680.cljs$lang$ctorStr = "cljs.core.async.impl.channels/t17680";
cljs.core.async.impl.channels.t17680.cljs$lang$ctorPrWriter = (function (this__3837__auto__,writer__3838__auto__,opt__3839__auto__){return cljs.core._write.call(null,writer__3838__auto__,"cljs.core.async.impl.channels/t17680");
});
cljs.core.async.impl.channels.t17680.prototype.cljs$core$IDeref$_deref$arity$1 = (function (_){var self__ = this;
var ___$1 = this;return self__.val;
});
cljs.core.async.impl.channels.t17680.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_17682){var self__ = this;
var _17682__$1 = this;return self__.meta17681;
});
cljs.core.async.impl.channels.t17680.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_17682,meta17681__$1){var self__ = this;
var _17682__$1 = this;return (new cljs.core.async.impl.channels.t17680(self__.val,self__.box,meta17681__$1));
});
cljs.core.async.impl.channels.__GT_t17680 = (function __GT_t17680(val__$1,box__$1,meta17681){return (new cljs.core.async.impl.channels.t17680(val__$1,box__$1,meta17681));
});
}
return (new cljs.core.async.impl.channels.t17680(val,box,null));
});
...
cljs.core.async.impl.channels.PutBox.cljs$lang$ctorPrWriter = (function (this__3840__auto__,writer__3841__auto__,opts__3842__auto__){return cljs.core._write.call(null,writer__3841__auto__,"cljs.core.async.impl.channels/PutBox");
});
...
cljs.core.async.impl.channels.ManyToManyChannel.cljs$lang$ctorPrWriter = (function (this__3837__auto__,writer__3838__auto__,opt__3839__auto__){return cljs.core._write.call(null,writer__3838__auto__,"cljs.core.async.impl.channels/ManyToManyChannel");
});
...
{self__.closed = true;
while(true){
var taker_17683 = self__.takes.pop();if((taker_17683 == null))
{} else
{if(cljs.core.async.impl.protocols.active_QMARK_.call(null,taker_17683))
{var take_cb_17684 = cljs.core.async.impl.protocols.commit.call(null,taker_17683);cljs.core.async.impl.dispatch.run.call(null,((function (take_cb_17684,taker_17683){
return (function (){return take_cb_17684.call(null,null);
});})(take_cb_17684,taker_17683))
);
} else
{}
{
