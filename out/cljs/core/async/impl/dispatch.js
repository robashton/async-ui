...
cljs.core.async.impl.dispatch.queued_QMARK_ = false;
var count_17674 = 0;while(true){
var m_17675 = cljs.core.async.impl.dispatch.tasks.pop();if((m_17675 == null))
{} else
{m_17675.call(null);
if((count_17674 < cljs.core.async.impl.dispatch.TASK_BATCH_SIZE))
{{
var G__17676 = (count_17674 + 1);
count_17674 = G__17676;
continue;
}
} else
{}
...
{}
cljs.core.async.impl.dispatch.queue_dispatcher = (function queue_dispatcher(){if(cljs.core.truth_((function (){var and__3281__auto__ = cljs.core.async.impl.dispatch.queued_QMARK_;if(and__3281__auto__)
