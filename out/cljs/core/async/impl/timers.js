...
cljs.core.async.impl.timers.SkipListNode.cljs$lang$ctorPrWriter = (function (this__3837__auto__,writer__3838__auto__,opt__3839__auto__){return cljs.core._write.call(null,writer__3838__auto__,"cljs.core.async.impl.timers/SkipListNode");
});
...
var skip_list_node__3 = (function (k,v,level){var arr = (new Array((level + 1)));var i_17639 = 0;while(true){
if((i_17639 < arr.length))
{(arr[i_17639] = null);
{
var G__17640 = (i_17639 + 1);
i_17639 = G__17640;
continue;
}
} else
...
cljs.core.async.impl.timers.SkipList.cljs$lang$ctorPrWriter = (function (this__3837__auto__,writer__3838__auto__,opt__3839__auto__){return cljs.core._write.call(null,writer__3838__auto__,"cljs.core.async.impl.timers/SkipList");
});
...
{var i_17646 = (self__.level + 1);while(true){
if((i_17646 <= (new_level + 1)))
{(update[i_17646] = self__.header);
{
...
var coll = this;var update = (new Array(cljs.core.async.impl.timers.MAX_LEVEL));var x = cljs.core.async.impl.timers.least_greater_node.call(null,self__.header,k,self__.level,update);var x__$1 = (x.forward[0]);if((!((x__$1 == null))) && ((x__$1.key === k)))
{var i_17648 = 0;while(true){
if((i_17648 <= self__.level))
{var links_17649 = (update[i_17648]).forward;if(((links_17649[i_17648]) === x__$1))
{(links_17649[i_17648] = (x__$1.forward[i_17648]));
{
var G__17650 = (i_17648 + 1);
i_17648 = G__17650;
continue;
}
} else
{{
var G__17651 = (i_17648 + 1);
i_17648 = G__17651;
continue;
}
}
...
*/
cljs.core.async.impl.timers.timeout = (function timeout(msecs){var timeout__$1 = ((new Date()).valueOf() + msecs);var me = cljs.core.async.impl.timers.timeouts_map.ceilingEntry(timeout__$1);var or__3293__auto__ = (cljs.core.truth_((function (){var and__3281__auto__ = me;if(cljs.core.truth_(and__3281__auto__))
{return (me.key < (timeout__$1 + cljs.core.async.impl.timers.TIMEOUT_RESOLUTION_MS));
} else
{return and__3281__auto__;
}
})())?me.val:null);if(cljs.core.truth_(or__3293__auto__))
