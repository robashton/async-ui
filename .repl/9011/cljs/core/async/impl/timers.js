...
cljs.core.async.impl.timers.SkipListNode.cljs$lang$ctorPrWriter = (function (this__9284__auto__,writer__9285__auto__,opt__9286__auto__){return cljs.core._write.call(null,writer__9285__auto__,"cljs.core.async.impl.timers/SkipListNode");
});
...
var skip_list_node__3 = (function (k,v,level){var arr = (new Array((level + 1)));var i_17869 = 0;while(true){
if((i_17869 < arr.length))
{(arr[i_17869] = null);
{
var G__17870 = (i_17869 + 1);
i_17869 = G__17870;
continue;
}
} else
...
cljs.core.async.impl.timers.SkipList.cljs$lang$ctorPrWriter = (function (this__9284__auto__,writer__9285__auto__,opt__9286__auto__){return cljs.core._write.call(null,writer__9285__auto__,"cljs.core.async.impl.timers/SkipList");
});
...
{var i_17876 = (self__.level + 1);while(true){
if((i_17876 <= (new_level + 1)))
{(update[i_17876] = self__.header);
{
...
var coll = this;var update = (new Array(cljs.core.async.impl.timers.MAX_LEVEL));var x = cljs.core.async.impl.timers.least_greater_node.call(null,self__.header,k,self__.level,update);var x__$1 = (x.forward[0]);if((!((x__$1 == null))) && ((x__$1.key === k)))
{var i_17878 = 0;while(true){
if((i_17878 <= self__.level))
{var links_17879 = (update[i_17878]).forward;if(((links_17879[i_17878]) === x__$1))
{(links_17879[i_17878] = (x__$1.forward[i_17878]));
{
var G__17880 = (i_17878 + 1);
i_17878 = G__17880;
continue;
}
} else
{{
var G__17881 = (i_17878 + 1);
i_17878 = G__17881;
continue;
}
}
...
*/
cljs.core.async.impl.timers.timeout = (function timeout(msecs){var timeout__$1 = ((new Date()).valueOf() + msecs);var me = cljs.core.async.impl.timers.timeouts_map.ceilingEntry(timeout__$1);var or__8740__auto__ = (cljs.core.truth_((function (){var and__8728__auto__ = me;if(cljs.core.truth_(and__8728__auto__))
{return (me.key < (timeout__$1 + cljs.core.async.impl.timers.TIMEOUT_RESOLUTION_MS));
} else
{return and__8728__auto__;
}
})())?me.val:null);if(cljs.core.truth_(or__8740__auto__))
