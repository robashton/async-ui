...
cljs.core.async.impl.dispatch.queued_QMARK_ = false;
var count_17904 = 0;while(true){
var m_17905 = cljs.core.async.impl.dispatch.tasks.pop();if((m_17905 == null))
{} else
{m_17905.call(null);
if((count_17904 < cljs.core.async.impl.dispatch.TASK_BATCH_SIZE))
{{
var G__17906 = (count_17904 + 1);
count_17904 = G__17906;
continue;
}
} else
{}
...
{}
cljs.core.async.impl.dispatch.queue_dispatcher = (function queue_dispatcher(){if(cljs.core.truth_((function (){var and__8728__auto__ = cljs.core.async.impl.dispatch.queued_QMARK_;if(and__8728__auto__)
