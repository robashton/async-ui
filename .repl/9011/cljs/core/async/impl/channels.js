...
goog.require('cljs.core.async.impl.protocols');
cljs.core.async.impl.channels.box = (function box(val){if(typeof cljs.core.async.impl.channels.t17910 !== 'undefined')
{} else
{
/**
* @constructor
*/
cljs.core.async.impl.channels.t17910 = (function (val,box,meta17911){
this.val = val;
this.box = box;
...
cljs.core.async.impl.channels.t17910.cljs$lang$type = true;
cljs.core.async.impl.channels.t17910.cljs$lang$ctorStr = "cljs.core.async.impl.channels/t17910";
cljs.core.async.impl.channels.t17910.cljs$lang$ctorPrWriter = (function (this__9284__auto__,writer__9285__auto__,opt__9286__auto__){return cljs.core._write.call(null,writer__9285__auto__,"cljs.core.async.impl.channels/t17910");
});
cljs.core.async.impl.channels.t17910.prototype.cljs$core$IDeref$_deref$arity$1 = (function (_){var self__ = this;
var ___$1 = this;return self__.val;
});
cljs.core.async.impl.channels.t17910.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_17912){var self__ = this;
var _17912__$1 = this;return self__.meta17911;
});
cljs.core.async.impl.channels.t17910.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_17912,meta17911__$1){var self__ = this;
var _17912__$1 = this;return (new cljs.core.async.impl.channels.t17910(self__.val,self__.box,meta17911__$1));
});
cljs.core.async.impl.channels.__GT_t17910 = (function __GT_t17910(val__$1,box__$1,meta17911){return (new cljs.core.async.impl.channels.t17910(val__$1,box__$1,meta17911));
});
}
return (new cljs.core.async.impl.channels.t17910(val,box,null));
});
...
cljs.core.async.impl.channels.PutBox.cljs$lang$ctorPrWriter = (function (this__9287__auto__,writer__9288__auto__,opts__9289__auto__){return cljs.core._write.call(null,writer__9288__auto__,"cljs.core.async.impl.channels/PutBox");
});
...
cljs.core.async.impl.channels.ManyToManyChannel.cljs$lang$ctorPrWriter = (function (this__9284__auto__,writer__9285__auto__,opt__9286__auto__){return cljs.core._write.call(null,writer__9285__auto__,"cljs.core.async.impl.channels/ManyToManyChannel");
});
...
{self__.closed = true;
while(true){
var taker_17913 = self__.takes.pop();if((taker_17913 == null))
{} else
{if(cljs.core.async.impl.protocols.active_QMARK_.call(null,taker_17913))
{var take_cb_17914 = cljs.core.async.impl.protocols.commit.call(null,taker_17913);cljs.core.async.impl.dispatch.run.call(null,((function (take_cb_17914,taker_17913){
return (function (){return take_cb_17914.call(null,null);
});})(take_cb_17914,taker_17913))
);
} else
{}
{
